        ...
        if (row.category === null) {
          ...
          return (
            <div key={i} style={{
              ...
              <span className="badge" style={{ fontSize: 11, color: dark ? C.cream : C.dark }}>
                {row.label}
              </span>
              <span className="mono" style={{ fontSize: 10, opacity: 0.7 }}>{bodyText}</span>
            </div>
          )
        }
                ...
                <div style={{ display: 'flex', gap: 6, marginTop: 6 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: 10, opacity: 0.4, color: dark ? C.cream : C.dark,
                    }}
                  >
                    cancel
                  </button>
