    ...
    <div style={{ position: 'relative', zIndex: 10, overflowX: 'hidden' }}>
      ...
      {(reminders.length > 0 || addingReminder) && (
        <div style={{ padding: '0 16px 4px' }}>
          <div style={{ fontSize: 'var(--fs-12)', fontWeight: 700, letterSpacing: '0.08em', color: C.rust, marginBottom: 6, fontFamily: 'Sora, system-ui, sans-serif' }}>
            DAILY REMINDERS
          </div>
          {reminders.map(r => (
            <div key={r.id} style={{
              ...
              {r.urgency === 'high' && <span style={{ fontSize: 'var(--fs-14)', flexShrink: 0 }}>!</span>}
              <span style={{ flex: 1, minWidth: 0, fontSize: 'var(--fs-15)', color: C.dark, lineHeight: 1.4, wordBreak: 'break-word' }}>{r.title}</span>
              <button onClick={() => handleSnooze(r.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 'var(--fs-12)', color: C.ink40, padding: '2px 4px' }}>zzz</button>
      ...
      <div style={{ padding: '0 16px 140px' }}>
        {loading ? (
          ...
          <div style={{
            ...
            color: C.ink40, fontSize: 'var(--fs-15)', lineHeight: 1.6,
          }}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8, padding: '5px 12px', fontSize: 'var(--fs-14)',
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', color: C.ink40, fontSize: 'var(--fs-18)', cursor: 'pointer', lineHeight: 1 }}
            >
              ×
            </button>
          </div>
          ...
          <div style={{ marginTop: 24 }}>
            ...
            {showDone && done.map(t => (
              <div key={t.id} style={{
                ...
                <span style={{ fontSize: 'var(--fs-16)', color: current.color }}>✓</span>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 1, flexShrink: 0 }}>
        <button
          ...
          style={{
            ...
            color: isFirst ? C.ink20 : C.ink40, fontSize: 'var(--fs-12)', lineHeight: 1, padding: '1px 3px',
          }}
        >▲</button>
        <button
          onClick={() => onMove('down')}
          ...
          style={{
            ...
            color: isLast ? C.ink20 : C.ink40, fontSize: 'var(--fs-12)', lineHeight: 1, padding: '1px 3px',
          }}
        >▼</button>
      </div>
      ...
      <button
        ...
        style={{
          ...
          fontSize: 'var(--fs-17)', cursor: 'pointer', lineHeight: 1, flexShrink: 0,
          padding: '0 2px',
        }}
      >×</button>
    </div>
